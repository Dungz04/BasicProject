...
const MovieActions = ({ movieId, type }) => {
    const watchUrl = type === "tv" ? `/xem-phim/${movieId}/season/1/episode/1?type=tv` : `/xem-phim/${movieId}?type=movie`;

    return (
        <div className="dm-bar">
            <div className="elements">
                <a className="btn btn-xl btn-rounded button-play flex-shrink-0" href={watchUrl}>
